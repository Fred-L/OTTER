...
int main() {
	...
	Texture2DData::sptr diffuse1Map = Texture2DData::LoadFromFile("images/box.bmp");
	...
	Texture2D::sptr diffuse1 = Texture2D::Create();
	diffuse1->LoadData(diffuse1Map);
	...
	while (!glfwWindowShouldClose(window)) {
		...
		shader->SetUniform("s_Diffuse1", 1);
