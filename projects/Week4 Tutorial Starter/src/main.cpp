...
int main() {
	...
	static const float interleaved3[] = {
		//     X      Y     Z       R     G    B
			...
			-0.5f,  0.5f, 0.0f,  1.0f, 3.0f, 0.0f,
			 0.5f,  1.0f, 0.0f,  1.0f, 1.0f, 5.0f
	};
	...
	while (!glfwWindowShouldClose(window)) {
		...
		transform3 = glm::translate(glm::mat4(1.0f), glm::vec3(glm::sin(static_cast<float>(thisFrame)), 0, 0.0f)) + glm::rotate(glm::mat4(1.0f), static_cast<float>(thisFrame), glm::vec3(0, 0, 1));
